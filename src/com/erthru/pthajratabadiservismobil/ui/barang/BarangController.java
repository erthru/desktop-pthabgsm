...
public class BarangController implements Initializable {
    ...
    private void tableBarangClicked(){
        ...
        txHarga.setText(barang.getHarga().replace("Rp. ", ""));
    ...
    @FXML
    private void txHargaOnTextChanged(){
        
        txHarga.setText(StringFex.numberWithComaOnly(txHarga.getText()));
        txHarga.positionCaret(txHarga.getText().length());
    ...
    private void tambahData(){
        ...
        class Work extends Task<Void>{
            ...
            protected Void call() throws Exception {
                ...
                params.add(new BasicNameValuePair("servis_harga",txHarga.getText().replace(",", "")));
