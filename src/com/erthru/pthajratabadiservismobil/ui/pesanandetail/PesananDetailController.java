            ...
            protected Void call() throws Exception {
                ...
                if(response != null){
                    ...
                    for(int i=0; i<bookingStatus.length(); i++){
                        ...
                        String id = bookingStatus.getJSONObject(i).getString("booking_status_id");
                        String createdAt = bookingStatus.getJSONObject(i).getString("booking_status_created_at");
                        String stat = bookingStatus.getJSONObject(i).getString("booking_status_stat");
                        
                        data.add(new Status(
                                id,StringFex.dateMax(createdAt),stat
                        ));
